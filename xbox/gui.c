...
void render_texture(void *pixels,  void *previous)
{
    if (renderer) {
        if (pixels) {
            SDL_UpdateTexture(texture, NULL, pixels, GB_get_screen_width(&gb) * sizeof (GB_output_color_t));
        }
...
configuration_t configuration =
{
    .joypad_configuration = {
        13, //JOYPAD_BUTTON_LEFT
        14, //JOYPAD_BUTTON_RIGHT
        11, //JOYPAD_BUTTON_UP
        12, //JOYPAD_BUTTON_DOWN
        0,  //JOYPAD_BUTTON_A
        1,  //JOYPAD_BUTTON_B
        6,  //JOYPAD_BUTTON_SELECT
        7,  //JOYPAD_BUTTON_START
        3,  //JOYPAD_BUTTON_MENU   (Y)
        5,  //JOYPAD_BUTTON_TURBO  (BLACK)
        4,  //JOYPAD_BUTTON_REWIND (WHITE)
        8,  //JOYPAD_BUTTON_SLOW_MOTION (LS)
        //X=2
        //Y=3
        //RS=9
        //LS=8
